...
function makeRequest(accessCode) {
  ...
  axios.post('https://app.clio.com/oauth/token', `client_id=${process.env.CLIENT_ID}&client_secret=${process.env.CLIENT_SECRET}&grant_type=authorization_code&code=${accessCode}&redirect_uri=https://clio-multi-timer-server.herokuapp.com/callback`)
    .then((res) => {
